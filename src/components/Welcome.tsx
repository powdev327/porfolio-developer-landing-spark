...
const Welcome = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex flex-col justify-center pt-16 bg-gradient-to-br from-blue-50 to-white overflow-hidden"
    >
      <div className="section-container flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-8 md:mb-0">
          <h2 className="text-xl md:text-2xl font-medium text-blue-600 mb-2 opacity-0 animate-fade-slide-up anim-delay-100">
            Hello, I'm
          </h2>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-navy-900 opacity-0 animate-fade-slide-up anim-delay-200">
            Full Stack <span className="highlight animate-pulse-shadow">Developer</span>
          </h1>
          <p className="text-lg text-gray-600 mb-8 max-w-lg opacity-0 animate-fade-slide-up anim-delay-300">
          ...
          <div className="flex flex-col sm:flex-row gap-4 opacity-0 animate-fade-slide-up anim-delay-400">
            <Button className="bg-navy-900 hover:bg-navy-800 hover-lift">
              View My Work
            </Button>
          ...
          <div className="mt-8 flex items-center space-x-4 opacity-0 animate-fade-slide-up anim-delay-500">
            <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors transform hover:scale-110 transition-transform">
              <Github size={22} />
            </a>
            <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors transform hover:scale-110 transition-transform">
              <Linkedin size={22} />
        ...
        <div className="md:w-1/2 flex justify-center" ref={profileRef}>
          <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 animate-pulse-shadow">
            <div className="absolute inset-2 rounded-full bg-white flex items-center justify-center overflow-hidden animate-float">
